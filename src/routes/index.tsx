...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "A loud, tactile drag-and-drop Kanban board in Desi Brutalist style.",
      },
      { property: "og:title", content: "Kaam Kanban — Desi Brutalist To-Do" },
      {
        property: "og:description",
        content: "Marigold, gulabi & peacock kanban with brutal black borders.",
      },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bungee&family=Space+Grotesk:wght@500;700&display=swap",
      },
    ],
  }),
  component: Index,
    ...
    <main className="desi-root min-h-dvh">
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
        <header className="mb-8 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            <p className="desi-display text-sm tracking-[0.3em] text-[#E0115F] mb-2">
              // KAAM KANBAN //
            </p>
            <h1 className="desi-display text-5xl md:text-7xl font-black leading-[0.9]">
              ...
              <br />
              KAL KA{" "}
              <span className="bg-[#00A86B] desi-border px-2 inline-block text-white">JASHN</span>
            </h1>
            <p className="mt-3 max-w-xl font-bold">
              Drag karo. Drop karo. Ho gaya. A brutally honest to-do board — keyboard friendly,
              screen-reader friendly, chai friendly.
            </p>
          </div>
          <button
            type="button"
